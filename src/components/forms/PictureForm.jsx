...
const PictureForm = props => {
  const { initialImage, onSubmit, onCancel, description } = props
  ...
  return (
    <div>
      ...
      <Formik
        ...
        validationSchema={pictureFormSchema}
      >
          ...
          return (
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              <div className="mb-5">
                ...
                <label
                  className={`text-gray-600 px-4 py-3 cursor-pointer w-full block text-sm border-dashed border-2 ${
                    isSubmitting ? 'cursor-not-allowed' : 'cursor-auto'
                  } ${errors.file ? 'border-red-400 bg-red-100' : 'border-blue-200 bg-gray-100'}`}
                >
                  ...
                  <div className="hidden">
                    <TextField
                      ...
                      values={!!values.file ? values.file.name : ''}
              ...
              <div className="flex justify-end">
                <div className="mr-2">
                  <Button size="small" type="submit" disabled={errors.file} loading={isSubmitting}>
                    Submit
                  </Button>
                </div>
                <div className="mr-2">
